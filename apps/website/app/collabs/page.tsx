  ...
  const collabs = [
    {
      ...
      category: 'Gaming',
      startAt: new Date('2026-10-10T12:00:00Z').toISOString(),
    ...
    },
    {
      ...
      category: 'Music',
      startAt: new Date('2026-10-11T12:00:00Z').toISOString(),
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 space-y-8">
        <header>
          ...
          <p className="text-gray-400 text-lg">
            Находите интересные стримы для совместного участия и расширяйте
            аудиторию.
          </p>
        </header>
        ...
        <div className="flex gap-4">
          <div className="flex-1 bg-[#161616] border border-gray-800 rounded-lg flex items-center px-4">
            ...
            <input
              type="text"
              placeholder="Поиск по играм, темам или стримерам..."
              className="w-full bg-transparent border-none px-4 py-3 focus:outline-none"
            />
          </div>
          <Button
            variant="outline"
            className="gap-2 border-gray-700 bg-[#161616]"
          >
