...
export default function DevicesPage() {
  const [devices, setDevices] = useState([
    {
      id: '1',
      name: 'OBS Studio - Игровой ПК',
      platform: 'win32',
      lastActive: 'Только что',
    },
    {
      id: '2',
      name: 'OBS Studio - Ноутбук',
      platform: 'darwin',
    ...
    <div className="max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      <header className="mb-8">
        ...
        <p className="text-gray-400 mt-2">
          Список авторизованных OBS-клиентов, привязанных к вашему аккаунту.
        </p>
      </header>
      ...
      <div className="space-y-4">
        {devices.map((device) => (
          <div
            key={device.id}
            className="bg-[#111] border border-[#222] p-6 rounded-2xl flex items-center justify-between group hover:border-gray-700 transition-colors"
          >
