    ...
    <div className="flex h-screen bg-[#0A0A0A] text-white">
      <aside className="w-64 bg-[#111] border-r border-[#222] p-6 flex flex-col">
        ...
        <nav className="flex-1 space-y-2">
          <Link
            href="/dashboard"
            className="flex items-center gap-3 px-3 py-2 rounded-lg text-gray-300 hover:text-white hover:bg-[#222] transition-colors"
          >
            <Home size={20} />
            Обзор
          </Link>
      ...
      <main className="flex-1 overflow-auto bg-[#0A0A0A] p-8">{children}</main>
    </div>
  );
}
