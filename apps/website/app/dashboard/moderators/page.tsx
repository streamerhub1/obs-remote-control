...
export default function ModeratorsPage() {
  return (
    <div className="max-w-5xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <header>
        <h1 className="text-3xl font-bold text-white tracking-tight">Модераторы</h1>
        <p className="text-gray-400 mt-2">Управляйте правами доступа к вашему OBS.</p>
      </header>
        ...
        <div className="bg-[#111] border border-[#222] rounded-2xl overflow-hidden">
          <div className="p-6 flex justify-between items-center border-b border-[#222] bg-[#141414]">
            <div className="flex items-center gap-4">
              <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Mod1" alt="avatar" className="w-12 h-12 rounded-full" />
              <div>
                <h3 className="font-medium text-white">Nightbot_Human</h3>
                <p className="text-sm text-gray-500">Запрос отправлен 10 минут назад</p>
              </div>
            </div>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-[#111] border border-[#222] p-5 rounded-2xl flex items-center justify-between group">
            <div className="flex items-center gap-4">
              <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Mod2" alt="avatar" className="w-12 h-12 rounded-full border border-[#333]" />
              <div>
                <h3 className="font-medium text-white">AwesomeMod</h3>
                <p className="text-xs text-green-500 font-medium">Полный доступ</p>
              </div>
            </div>
