          ...
          <Card className="bg-[#161616] border-gray-800">
            ...
            <CardContent className="space-y-3">
              <div className="text-sm p-3 bg-gray-800/30 rounded-lg border border-gray-800/50">
                <span className="font-semibold text-blue-400">VikingGamer</span>{' '}
                предложил коллаборацию (Демо)
              </div>
              <div className="text-sm p-3 bg-gray-800/30 rounded-lg border border-gray-800/50">
                <span className="font-semibold text-green-400">AnnaLive</span>{' '}
                принял заявку на модерацию (Демо)
              </div>
              <Button
                variant="outline"
            ...
            <CardContent className="flex-1 space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-300 line-clamp-3">
                  Ребята, завтра запускаю марафон на 24 часа! Кто хочет залететь
                  на совместные катки в CS2 - пишите в ЛС или кидайте заявки на
                  коллаб. Будет жарко! 🔥
                </p>
              </div>
