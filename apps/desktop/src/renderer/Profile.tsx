    ...
    return (
      <div className="bg-red-900/20 border border-red-800/40 rounded-xl p-8 text-center">
        ...
        <p className="text-gray-500 text-sm mb-4">
          Убедитесь, что вы вошли через Twitch и backend запущен.
        </p>
        ...
        <div className="absolute top-4 right-4">
          {!editing ? (
            ...
            <div className="flex gap-2">
              <Button
                variant="secondary"
                className="bg-black/50 border-none backdrop-blur-md"
          ...
          <>
            ...
            {!profile.bio && (
              <p className="text-gray-600 italic text-sm">
                Bio не заполнено. Нажмите «Редактировать», чтобы добавить
                описание.
              </p>
            )}
