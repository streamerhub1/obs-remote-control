      ...
      .values([
        {
          ...
          avatarUrl:
            'https://api.dicebear.com/7.x/avataaars/svg?seed=ProGamer_99',
      ...
      .values([
        {
          ...
          content:
            'Just finished an amazing 12-hour subathon! Thanks everyone for the support! 🎮💜',
          likesCount: 124,
          commentsCount: 15,
        },
        {
          ...
          content:
            'Looking for someone to collab on a Minecraft hardcore series this weekend. Any takers?',
          likesCount: 45,
          commentsCount: 8,
        },
      ])
