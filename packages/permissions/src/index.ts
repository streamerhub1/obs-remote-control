...
export const commandPermissionRegistry: Record<ObsCommand['type'], CommandPermissionMapping> = {
...
export const Presets = {
  Observer: ['obs.read', 'scenes.read', 'sceneItems.read', 'inputs.read', 'audio.read', 'filters.read', 'stream.read', 'record.read'] as PermissionKey[],
  ScenesOnly: ['obs.read', 'scenes.read', 'scenes.switch', 'stream.read', 'record.read'] as PermissionKey[],
  ScenesAndSources: ['obs.read', 'scenes.read', 'scenes.switch', 'sceneItems.read', 'sceneItems.visibility', 'stream.read', 'record.read'] as PermissionKey[],
  ScenesAndAudio: ['obs.read', 'scenes.read', 'scenes.switch', 'sceneItems.read', 'sceneItems.visibility', 'inputs.read', 'audio.read', 'audio.mute', 'audio.volume', 'stream.read', 'record.read'] as PermissionKey[],
  FullControl: [...PermissionKeys] as PermissionKey[]
};

export function getCommandPermission(commandType: ObsCommand['type']): CommandPermissionMapping | null {
